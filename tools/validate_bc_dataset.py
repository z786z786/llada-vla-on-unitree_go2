...
def _validate_episode(session_root: Path, episode_path: Path) -> Dict[str, Any]:
...
def main() -> None:
    ...
    for session_root in session_roots:
        ...
        for episode_meta in index_payload.get("episodes") or []:
            ...
            report = _validate_episode(session_root, episode_path)
            report["session_id"] = str(index_payload.get("session_id") or session_root.name)
